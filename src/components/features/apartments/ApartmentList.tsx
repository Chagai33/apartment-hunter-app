...
export function ApartmentList() {
    ...
    return (
        <div className="p-4 pb-24">
            ...
            <Link
                to="/add"
                className="fixed bottom-20 md:bottom-10 right-6 bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition-colors z-[49] flex items-center justify-center shadow-blue-500/30"
